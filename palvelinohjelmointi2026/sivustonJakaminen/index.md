...
```php
<footer>
<p>Trademark by Anna Metsäpelto 2026</p>
</footer>
</body>
</html>
```
...
<h2>Lesson 1</h2>
<p>This is how you make PHP combine files into one HTML file.</p>
...
1. Luo uuteen kansioon tiedostot nimiltään *index.php*, *header.php*, *articles.php* ja *footer.php*. 
