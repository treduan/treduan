...
*foreach* toimii vain taulukoiden kanssa. Tässä esimerkissä oletetaan, että koodipätkä on osa HTML-koodia ja jokainen nimi taulukosta lisätään sivulla listaan.
