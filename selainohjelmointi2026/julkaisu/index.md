...
GitHub pagesin kautta voi julkaista ilmaiseksi verkkosivuja, jotka ovat omana repositoryna GitHubissa. Näissä ei kuitenkaan voi olla mukana tietokantaa. Jos haluat julkaista verkkosivuston, jossa on mukana tietokanta, se pitää tehdä jotain toista kautta (koulun kautta C-panel). Eli sivut, joilla on HTML, CSS ja JavaScript on mahdollista julkaista GitHub Pagesin kautta.

## Sivujen julkaisu

1. Luo GitHubissa ensin uusi repository, joka on tyypiltään Public. Anna sille nimi, jonka haluat näkyvän sivuston osoitteena. Sivuston osoitteeksi tulee automaattisesti (githubin käyttäjänimi).github.io/(repositoryn nimi). Jos ostat domain-nimen, voit vaihtaa sen sivuston osoitteeksi.
...
4. Tarkista, että sivusto edelleen toimii omalla tietokoneellasi ja tee commit ja push Gitissä.
